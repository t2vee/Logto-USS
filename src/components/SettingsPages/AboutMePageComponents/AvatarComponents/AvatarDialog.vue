...
const AvatarGallery = defineAsyncComponent(
  () =>
    import('@/components/SettingsPages/AboutMePageComponents/AvatarComponents/AvatarGallery.vue')
)
const ImageUploader = defineAsyncComponent(
  () =>
    import('@/components/SettingsPages/AboutMePageComponents/AvatarComponents/ImageUploader.vue')
)
