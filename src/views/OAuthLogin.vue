...
const onClickSignIn = () => signIn(`${import.meta.env.VITE_ROOT}/oauth/callback`)
</script>
    ...
    <div class="flex flex-col items-center">
      <div v-if="isAuthenticated">
        <Card class="w-[350px]">
          ...
          <CardFooter> <Copyright /> Vee @ 2024 </CardFooter>
        </Card>
      </div>
      <div v-else class="flex flex-col items-center">
        <Card class="w-[350px]">
          <CardHeader>
            <CardTitle>Login To Your Account Dashboard 👉</CardTitle>
            <CardDescription
              >To access and modify settings and support tickets you must be
              authenticated.</CardDescription
            >
          </CardHeader>
          <CardContent>
